...
uint8_t __ALIGNED(4096) EPBufPool[
    ...
    USBD_CDC_ACM_ENABLE * ((HS(USBD_CDC_ACM_1_HS_ENABLE) ? USBD_CDC_ACM_1_HS_WMAXPACKETSIZE : USBD_CDC_ACM_1_WMAXPACKETSIZE)      +
                           (HS(USBD_CDC_ACM_1_HS_ENABLE) ? USBD_CDC_ACM_1_HS_WMAXPACKETSIZE1 : USBD_CDC_ACM_1_WMAXPACKETSIZE1) * 2) +
