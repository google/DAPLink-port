...
#define USBD_CDC_ACM_1_EP_INTIN         5
#define USBD_CDC_ACM_1_EP_INTIN_STACK   0
#define USBD_CDC_ACM_1_WMAXPACKETSIZE   16
#define USBD_CDC_ACM_1_BINTERVAL        32
#define USBD_CDC_ACM_1_HS_ENABLE        0
#define USBD_CDC_ACM_1_HS_WMAXPACKETSIZE 16
#define USBD_CDC_ACM_1_HS_BINTERVAL     2
#define USBD_CDC_ACM_1_EP_BULKIN        6
#define USBD_CDC_ACM_1_EP_BULKOUT       7
#define USBD_CDC_ACM_1_EP_BULKIN_STACK  0
#define USBD_CDC_ACM_1_WMAXPACKETSIZE1  64
#define USBD_CDC_ACM_1_HS_ENABLE1       0
#define USBD_CDC_ACM_1_HS_WMAXPACKETSIZE1 64
#define USBD_CDC_ACM_1_HS_BINTERVAL1    0
#define USBD_CDC_ACM_1_CIF_STRDESC      L"mbed Serial Port"
#define USBD_CDC_ACM_1_DIF_STRDESC      L"mbed Serial Port"
#define USBD_CDC_ACM_1_SENDBUF_SIZE     64
#define USBD_CDC_ACM_1_RECEIVEBUF_SIZE  64
...
#define USBD_EP_NUM_CALC2           MAX((USBD_ADC_ENABLE    *(USBD_ADC_EP_ISOOUT    )), (USBD_CDC_ACM_ENABLE*(USBD_CDC_ACM_1_EP_INTIN)))
#define USBD_EP_NUM_CALC3           MAX((USBD_CDC_ACM_ENABLE*(USBD_CDC_ACM_1_EP_BULKIN)), (USBD_CDC_ACM_ENABLE*(USBD_CDC_ACM_1_EP_BULKOUT)))
