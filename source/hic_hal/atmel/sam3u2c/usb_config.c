...
#define USBD_CDC_ACM_1_EP_INTIN         4
...
#define USBD_CDC_ACM_1_HS_BINTERVAL1    1
#define USBD_CDC_ACM_1_CIF_STRDESC      L"mbed Serial Port"
#define USBD_CDC_ACM_1_DIF_STRDESC      L"mbed Serial Port"
#define USBD_CDC_ACM_1_SENDBUF_SIZE     USBD_CDC_ACM_1_HS_WMAXPACKETSIZE1
#define USBD_CDC_ACM_1_RECEIVEBUF_SIZE  USBD_CDC_ACM_1_HS_WMAXPACKETSIZE1
