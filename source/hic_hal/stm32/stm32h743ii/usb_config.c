...
#ifndef CDC_B_ENDPOINT
#define CDC_B_ENDPOINT 0
#else
#define CDC_B_ENDPOINT 1
#endif
#define USBD_CDC_B_ACM_ENABLE             CDC_B_ENDPOINT
#define USBD_CDC_B_ACM_EP_INTIN           5  // Mutually exclusive with non-bulk HID
...
#error "Send Buffer size must be larger or equal to Bulk In maximum packet size!"
#endif
#if (((USBD_CDC_B_ACM_HS_ENABLE1) && (USBD_CDC_B_ACM_RECEIVEBUF_SIZE < USBD_CDC_B_ACM_HS_WMAXPACKETSIZE1)) || (USBD_CDC_B_ACM_RECEIVEBUF_SIZE < USBD_CDC_B_ACM_WMAXPACKETSIZE1))
#error "Receive Buffer size must be larger or equal to Bulk Out maximum packet size!"
#endif
...
#if  (((USBD_HID_EP_INTIN   == USBD_CDC_B_ACM_EP_INTIN)   || \
       (USBD_HID_EP_INTIN   == USBD_CDC_B_ACM_EP_BULKIN)  || \
       (USBD_HID_EP_INTIN   == USBD_CDC_B_ACM_EP_BULKOUT))|| \
      ((USBD_HID_EP_INTOUT  != 0)                       && \
      ((USBD_HID_EP_INTOUT  == USBD_CDC_B_ACM_EP_INTIN)   || \
       (USBD_HID_EP_INTOUT  == USBD_CDC_B_ACM_EP_BULKIN)  || \
       (USBD_HID_EP_INTOUT  == USBD_CDC_B_ACM_EP_BULKOUT))))
...
#endif
#if    (USBD_CDC_B_ACM_ENABLE)
#if   ((USBD_MSC_EP_BULKIN  == USBD_CDC_B_ACM_EP_INTIN)   || \
       (USBD_MSC_EP_BULKIN  == USBD_CDC_B_ACM_EP_BULKIN)  || \
       (USBD_MSC_EP_BULKIN  == USBD_CDC_B_ACM_EP_BULKOUT) || \
       (USBD_MSC_EP_BULKOUT == USBD_CDC_B_ACM_EP_INTIN)   || \
       (USBD_MSC_EP_BULKOUT == USBD_CDC_B_ACM_EP_BULKIN)  || \
       (USBD_MSC_EP_BULKOUT == USBD_CDC_B_ACM_EP_BULKOUT))
...
#endif
#if    (USBD_CDC_B_ACM_ENABLE)
#if   ((USBD_ADC_EP_ISOOUT  == USBD_CDC_B_ACM_EP_INTIN)   || \
       (USBD_ADC_EP_ISOOUT  == USBD_CDC_B_ACM_EP_BULKIN)  || \
       (USBD_ADC_EP_ISOOUT  == USBD_CDC_B_ACM_EP_BULKOUT))
...
#if    (USBD_CDC_ACM_ENABLE)
#if    (USBD_CDC_B_ACM_ENABLE)
#if   ((USBD_CDC_ACM_EP_INTIN == USBD_CDC_B_ACM_EP_INTIN)   || \
       (USBD_CDC_ACM_EP_INTIN == USBD_CDC_B_ACM_EP_BULKIN)  || \
       (USBD_CDC_ACM_EP_INTIN == USBD_CDC_B_ACM_EP_BULKOUT) || \
       (USBD_CDC_ACM_EP_BULKIN == USBD_CDC_B_ACM_EP_INTIN)   || \
       (USBD_CDC_ACM_EP_BULKIN == USBD_CDC_B_ACM_EP_BULKIN)  || \
       (USBD_CDC_ACM_EP_BULKIN == USBD_CDC_B_ACM_EP_BULKOUT) || \
       (USBD_CDC_ACM_EP_BULKOUT == USBD_CDC_B_ACM_EP_INTIN)   || \
       (USBD_CDC_ACM_EP_BULKOUT == USBD_CDC_B_ACM_EP_BULKIN)  || \
       (USBD_CDC_ACM_EP_BULKOUT == USBD_CDC_B_ACM_EP_BULKOUT))
...
#define USBD_CDC_B_ACM_CIF_STR_NUM  (3+USBD_STRDESC_SER_ENABLE+USBD_ADC_ENABLE*3+USBD_CDC_ACM_ENABLE*2+0)
#define USBD_CDC_B_ACM_DIF_STR_NUM  (3+USBD_STRDESC_SER_ENABLE+USBD_ADC_ENABLE*3+USBD_CDC_ACM_ENABLE*2+1)
#define USBD_HID_IF_STR_NUM        (3+USBD_STRDESC_SER_ENABLE+USBD_ADC_ENABLE*3+USBD_CDC_ACM_ENABLE*2+USBD_CDC_B_ACM_ENABLE*2)
#define USBD_WEBUSB_IF_STR_NUM     (3+USBD_STRDESC_SER_ENABLE+USBD_ADC_ENABLE*3+USBD_CDC_ACM_ENABLE*2+USBD_CDC_B_ACM_ENABLE*2+USBD_HID_ENABLE)
#define USBD_MSC_IF_STR_NUM        (3+USBD_STRDESC_SER_ENABLE+USBD_ADC_ENABLE*3+USBD_CDC_ACM_ENABLE*2+USBD_CDC_B_ACM_ENABLE*2+USBD_HID_ENABLE+USBD_WEBUSB_ENABLE)
#define USBD_BULK_IF_STR_NUM       (3+USBD_STRDESC_SER_ENABLE+USBD_ADC_ENABLE*3+USBD_CDC_ACM_ENABLE*2+USBD_CDC_B_ACM_ENABLE*2+USBD_HID_ENABLE+USBD_WEBUSB_ENABLE+USBD_MSC_ENABLE)
...
#endif
#if    (USBD_CDC_B_ACM_ENABLE)
#if    (USBD_CDC_B_ACM_HS_ENABLE)
#define USBD_CDC_B_ACM_MAX_PACKET   ((USBD_CDC_B_ACM_HS_WMAXPACKETSIZE > USBD_CDC_B_ACM_WMAXPACKETSIZE) ? USBD_CDC_B_ACM_HS_WMAXPACKETSIZE : USBD_CDC_B_ACM_WMAXPACKETSIZE)
#else
#define USBD_CDC_B_ACM_MAX_PACKET    (USBD_CDC_B_ACM_WMAXPACKETSIZE)
#endif
#if    (USBD_CDC_B_ACM_HS_ENABLE1)
#define USBD_CDC_B_ACM_MAX_PACKET1  ((USBD_CDC_B_ACM_HS_WMAXPACKETSIZE1 > USBD_CDC_B_ACM_WMAXPACKETSIZE1) ? USBD_CDC_B_ACM_HS_WMAXPACKETSIZE1 : USBD_CDC_B_ACM_WMAXPACKETSIZE1)
#else
#define USBD_CDC_B_ACM_MAX_PACKET1   (USBD_CDC_B_ACM_WMAXPACKETSIZE1)
#endif
#else
#define USBD_CDC_B_ACM_MAX_PACKET    (0)
#define USBD_CDC_B_ACM_MAX_PACKET1   (0)
#endif
#if    (USBD_BULK_ENABLE)
...
#define USBD_MAX_PACKET_CALC4     ((USBD_CDC_B_ACM_MAX_PACKET1 > USBD_MSC_MAX_PACKET      ) ? (USBD_CDC_B_ACM_MAX_PACKET1) : (USBD_MSC_MAX_PACKET      ))
