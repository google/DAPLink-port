...
/* USB Device CDC_B ACM class functions called automatically by USBD Core module*/
extern int32_t  USBD_CDC_B_ACM_Initialize(void);
extern int32_t  USBD_CDC_B_ACM_Uninitialize(void);
extern int32_t  USBD_CDC_B_ACM_Reset(void);
/* USB Device CDC_B ACM class user functions                                    */
extern int32_t  USBD_CDC_B_ACM_PortInitialize(void);
extern int32_t  USBD_CDC_B_ACM_PortUninitialize(void);
extern int32_t  USBD_CDC_B_ACM_PortReset(void);
extern int32_t  USBD_CDC_B_ACM_PortSetLineCoding(CDC_LINE_CODING *line_coding);
extern int32_t  USBD_CDC_B_ACM_PortGetLineCoding(CDC_LINE_CODING *line_coding);
extern int32_t  USBD_CDC_B_ACM_PortSetControlLineState(uint16_t ctrl_bmp);
extern int32_t  USBD_CDC_B_ACM_DataSend(const uint8_t *buf, int32_t len);
extern int32_t  USBD_CDC_B_ACM_DataFree(void);
extern int32_t  USBD_CDC_B_ACM_PutChar(const uint8_t  ch);
extern int32_t  USBD_CDC_B_ACM_DataRead(uint8_t *buf, int32_t len);
extern int32_t  USBD_CDC_B_ACM_GetChar(void);
extern int32_t  USBD_CDC_B_ACM_DataAvailable(void);
extern int32_t  USBD_CDC_B_ACM_Notify(uint16_t stat);
/* USB Device CDC_B ACM class overridable functions                             */
